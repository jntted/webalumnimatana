...
<form action="{{ route('data.store', 'student') }}" method="POST" class="space-y-4">
    @csrf
    <div>
    ...
    <div>
        ...
        <textarea id="address" name="address" required rows="3"
            class="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 text-slate-900"></textarea>
    </div>
